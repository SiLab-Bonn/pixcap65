...
def r13_analysator_second(tb_lock, correction_args, **kwargs):
    ...
    print("Fetch new authkey:", mp.current_process().authkey)
    ...
    analyze_data(raw_data=R13_2_SCAN_FILE, base_path="{}/{}/biased_80_V_full".format(top_ref, name), is_advanced=True,
                 ...
                 **correction_args)
    analyze_data(raw_data=R13_2_SCAN_FILE, base_path="{}/{}/unbiased_1_full_model".format(top_ref, name),
                 is_advanced=True,
                 ...
                 **correction_args)
    analyze_data(raw_data=R13_2_SCAN_FILE, base_path="{}/{}/biased_80_V_full_model".format(top_ref, name),
                 is_advanced=True,
    ...
    analyze_data(raw_data=R13_2_SCAN_FILE, base_path="{}/{}/inter_unbiased_renew_Extended_full".format(top_ref, name),
                 lock=tb_lock, distribution=True, exclude_test_cap=True,
                 is_advanced=True, full_model=False, is_inter_pixel=True,
                 total_cap_file=R13_2_SCAN_FILE,
                 total_cap_group="{}/{}/unbiased_1_full_model/total_cap".format(top_ref, name))
    analyze_data(raw_data=R13_2_SCAN_FILE,
                 base_path="{}/{}/inter_biased_M_80_V_renew_Extended_full".format(top_ref, name),
                 lock=tb_lock, distribution=True, exclude_test_cap=True,
                 is_advanced=True, full_model=False, is_inter_pixel=True,
                 total_cap_file=R13_2_SCAN_FILE,
                 total_cap_group="{}/{}/biased_80_V_full_model/total_cap".format(top_ref, name))
    analyze_data(raw_data=R13_2_SCAN_FILE,
                 base_path="{}/{}/inter_unbiased_renew_Extended_full_model".format(top_ref, name),
                 lock=tb_lock, distribution=True, exclude_test_cap=True,
                 is_advanced=True, full_model=True, is_inter_pixel=True,
                 total_cap_file=R13_2_SCAN_FILE,
                 total_cap_group="{}/{}/unbiased_1_full_model/total_cap".format(top_ref, name))
    analyze_data(raw_data=R13_2_SCAN_FILE,
                 base_path="{}/{}/inter_biased_M_80_V_renew_Extended_full_model".format(top_ref, name),
                 lock=tb_lock, distribution=True, exclude_test_cap=True,
                 is_advanced=True, full_model=True, is_inter_pixel=True,
                 total_cap_file=R13_2_SCAN_FILE,
                 total_cap_group="{}/{}/biased_80_V_full_model/total_cap".format(top_ref, name))
...
def e1_analysator_second(tb_lock, correction_args, **kwargs):
    ...
    analyze_data(raw_data=E1_2_SCAN_FILE, base_path="{}/{}/unbiased_full".format(top_ref, name), is_advanced=True,
                 lock=tb_lock,
                 full_model=False, distribution=True, exclude_cap_test=True, mask_pixel=data_constants.e1_pixel_mask,
                 **correction_args)
    analyze_data(raw_data=E1_2_SCAN_FILE, base_path="{}/{}/biased_80_V_full".format(top_ref, name), is_advanced=True,
                 lock=tb_lock,
                 full_model=False, distribution=True, exclude_cap_test=True, mask_pixel=data_constants.e1_pixel_mask,
                 **correction_args)
    analyze_data(raw_data=E1_2_SCAN_FILE, base_path="{}/{}/unbiased_full_model".format(top_ref, name), is_advanced=True,
                 lock=tb_lock,
                 distribution=True, exclude_cap_test=True, mask_pixel=data_constants.e1_pixel_mask, **correction_args)
    analyze_data(raw_data=E1_2_SCAN_FILE, base_path="{}/{}/biased_80_V_full_model".format(top_ref, name),
...
def x1_analysator(tb_lock, correction_args, **kwargs):
    ...
    #
    # analyze_data(raw_data=X1_SCAN_2_FILE, base_path="{}/{}/unbiased_61_full".format(top_ref, name), is_advanced=True,
    #              full_model=False,
    ...
    #              **correction_args)
    # analyze_data(raw_data=X1_SCAN_2_FILE, base_path="{}/{}/biased_80_V_full".format(top_ref, name), is_advanced=True,
    #              full_model=False,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    ...
    #              base_path="{}/{}/biased_200_V_full".format(top_ref, name), is_advanced=True,
    #              full_model=False,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock, **correction_args)
    # analyze_data(raw_data=X1_SCAN_2_FILE, base_path="{}/{}/unbiased_61_full_model".format(top_ref, name),
    #              is_advanced=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock, fit_plot_pdf_name="Fit References/{}/unbiased_full_model.pdf".format(name), plot=True,
    #              **correction_args)
    # analyze_data(raw_data=X1_SCAN_2_FILE, base_path="{}/{}/biased_80_V_full_model".format(top_ref, name),
    #              is_advanced=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              fit_plot_pdf_name="Fit References/{}/biased_full_model.pdf".format(name), plot=True,
    #              lock=tb_lock, **correction_args)
    # analyze_data(raw_data="packaged/data/X1_12_Renew_Scan.h5",
    #              base_path="{}/{}/biased_200_V_full_model".format(top_ref, name),
    #              is_advanced=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock, **correction_args)
    #
    ...
    #
    # analyze_data(raw_data="packaged/data/X1_12_Renew_Scan.h5",
    #              base_path="{}/{}/inter_unbiased_full_renew_Extended".format(top_ref, name),
    #              is_advanced=True, full_model=False, is_inter_pixel=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock,
    #              total_cap_file=X1_SCAN_2_FILE,
    #              total_cap_group="{}/{}/unbiased_61_full_model/total_cap".format(top_ref, name))
    # analyze_data(raw_data="packaged/data/X1_12_Renew_Scan.h5",
    #              base_path="{}/{}/inter_unbiased_full_model_renew_Extended".format(top_ref, name),
    #              is_advanced=True, full_model=True, is_inter_pixel=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock,
    #              total_cap_file=X1_SCAN_2_FILE,
    #              total_cap_group="{}/{}/unbiased_61_full_model/total_cap".format(top_ref, name))
    # analyze_data(raw_data="packaged/data/X1_12_Renew_Scan.h5",
    #              base_path="{}/{}/inter_biased_M_200_V_full_renew_Extended".format(top_ref, name),
    #              is_advanced=True, full_model=False, is_inter_pixel=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock,
    #              total_cap_file="packaged/data/X1_12_Renew_Scan.h5",
    #              total_cap_group="{}/{}/biased_200_V_full_model/total_cap".format(top_ref, name))
    # analyze_data(raw_data="packaged/data/X1_12_Renew_Scan.h5",
    #              base_path="{}/{}/inter_biased_M_200_V_full_model_renew_Extended".format(top_ref, name),
    #              is_advanced=True, full_model=True, is_inter_pixel=True,
    #              distribution=True, exclude_test_cap=True, pixel_mask=data_constants.x1_second_pixel_mask,
    #              lock=tb_lock,
    #              total_cap_file="packaged/data/X1_12_Renew_Scan.h5",
...
def x2_analysator(tb_lock, correction_args, **kwargs):
    ...
    #                       recursive=True, overwrite=True)
    #
    # analyze_data(raw_data=X2_SCAN_2_FILE, base_path="{}/{}/unbiased_1_full".format(top_ref, name), is_advanced=True,
    #              lock=tb_lock,
    #              full_model=False, distribution=True, **correction_args)
    # analyze_data(raw_data=X2_SCAN_2_FILE, base_path="{}/{}/biased_80_V_full".format(top_ref, name), is_advanced=True,
    #              lock=tb_lock,
    #              full_model=False, distribution=True, **correction_args)
    # analyze_data(raw_data=X2_SCAN_2_FILE, base_path="{}/{}/biased_200_V_full".format(top_ref, name), is_advanced=True,
    #              lock=tb_lock,
    #              full_model=False, distribution=True, **correction_args)
    # analyze_data(raw_data=X2_SCAN_2_FILE, base_path="{}/{}/unbiased_1_full_model".format(top_ref, name),
    #              is_advanced=True, lock=tb_lock,
    #              distribution=True, **correction_args)
    # analyze_data(raw_data=X2_SCAN_2_FILE, base_path="{}/{}/biased_80_V_full_model".format(top_ref, name),
    #              is_advanced=True, lock=tb_lock,
    #              distribution=True, **correction_args)
...
def x6_analysator(tb_lock, correction_args, **kwargs):
    ...
    analyze_data(raw_data=data_constants.X6_SCAN_FILE,
                 base_path="{}/{}/inter_biased_M_45_V_full_model".format(top_ref, name),
                 is_advanced=True, full_model=True, is_inter_pixel=True,
                 exclude_cap_test=True, distribution=True,
                 lock=tb_lock,
                 total_cap_file=data_constants.X6_SCAN_FILE,
...
def x7_analysator(tb_lock, correction_args, **kwargs):
    ...
    analyze_data(raw_data=data_constants.X7_SCAN_FILE, base_path="{}/{}/unbiased_full".format(top_ref, name),
                 is_advanced=True,
    ...
    analyze_data(raw_data=data_constants.X7_SCAN_FILE,
                 base_path="{}/{}/inter_biased_M_40.0_V_full".format(top_ref, name),
                 is_advanced=True, full_model=False, is_inter_pixel=True,
                 exclude_cap_test=True, distribution=True, lock=tb_lock,
                 total_cap_file=data_constants.X7_SCAN_FILE,
    ...
    analyze_data(raw_data=data_constants.X7_SCAN_FILE,
                 ...
                 total_cap_group="{}/{}/unbiased_full/total_cap".format(top_ref, name))
    analyze_data(raw_data=data_constants.X7_SCAN_FILE,
                 base_path="{}/{}/inter_biased_M_40.0_V_full_model".format(top_ref, name),
                 is_advanced=True, full_model=True, is_inter_pixel=True,
                 exclude_cap_test=True, distribution=True, lock=tb_lock,
                 total_cap_file=data_constants.X7_SCAN_FILE,
